...
class TripPlanTripTableItemComponent extends Component {
    ...
    render() {
        return <li className="wd-td-item text-center justify-content-center align-content-center">
            {!this.state.beingEdited && <ul className="wd-td-headline">{this.state.trip.places &&
                                                                                 this.state.trip.places.map(
                    (place, index) =>
                        <li className="d-block my-1" key={index}>{place}</li>
            )}</ul>}
            {this.state.beingEdited &&
             <textarea className="form-control wd-td-headline"
            ...
            <div>
                {!this.state.beingEdited &&
                 <div className="mt-4 text-center">
                     <button className="btn wd-td-table-btn mr-3"
                             onClick={() => this.setState({beingEdited: true})}>Edit
                     </button>
                     <button className="btn wd-td-table-btn"
                ...
                {this.state.beingEdited &&
                 <div>
                     <button className="btn wd-td-table-btn mt-3 btn-block"
