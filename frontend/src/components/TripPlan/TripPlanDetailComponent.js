...
class TripPlanDetailComponent extends React.Component {
    ...
    render() {
        return <div className="wd-row container-fluid plan-align">
            {!this.state.isLogin &&
            ...
            <div className="col-md-6 col-lg-5 min-vh-100">
                <span className="p-2">
                    <span>
                    <Link className="btn wd-td-peach border-0 m-1 wd-fixed-btn wd-high-index" to={`/user/${this.state.userId}/plans`}><FaArrowLeft size={28}/></Link>
                    <h4 className="h4 text-center m-2 pb-0 wd-td-headline font-weight-bold text-uppercase">{this.state.plan.name}</h4>
                        <h5 className="h5 text-center m-2 pb-0 wd-border-bot-3 wd-td-headline font-weight-bold text-uppercase">
