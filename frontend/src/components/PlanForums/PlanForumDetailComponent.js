...
class PlanForumDetailComponent extends React.Component {
    ...
    render() {
        return <div className="wd-row container-fluid">
            <div className="col-md-6 col-lg-5 min-vh-100">
                <span className="p-2">
                    <span>
                    <Link className="btn wd-td-peach border-0 m-1 wd-fixed-btn wd-high-index"
            ...
            <div className="col-md-6 col-lg-7 border-left d-none d-md-block">
                <div className="wd-map-detail container-md">
                    <MapComponent/>
                </div>
            </div>
        </div>
