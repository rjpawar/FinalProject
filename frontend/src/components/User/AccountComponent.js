...
export default class UserProfile extends Component {
    state = {
        ...
        favloc: localStorage.getItem('user') !== null ? JSON.parse(localStorage.getItem('user')).favloc : '',
        plans: []
    }
                                                        ...
                                                        <div className="col">
                                                            <div className="form-group">
                                                                ...
                                                                <input className="form-control"
                                                                       type="text"
                                                                       onChange={e =>
                                                                           this.setState({favloc: e.target.value})}
                                                                       value={this.state.favloc}/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="wd-row">
